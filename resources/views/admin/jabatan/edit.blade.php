            ...
            <div class="col-md-4">
                <div class="card full-height">
                    <div class="card-body">
                        ...
                        <form action="/jabatan/{{ $data->uuid }}/update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                       ...
                                       <input type="text" name="kode" id="" class="form-control" value="{{ $data->kode }}" >
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label >Nama Jabatan</label>
                                       <input type="text" name="nama_jabatan" id="" class="form-control" value="{{ $data->nama_jabatan }}">
                                    </div>
                                </div>
                        
                            
                            </div>
                          <button class="btn btn-warning ml-2 mt-4" type="submit">update</button>
